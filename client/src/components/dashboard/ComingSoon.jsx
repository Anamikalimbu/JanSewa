...
/**
 * components/dashboard/ComingSoon.jsx
 * Lightweight placeholder shell used by dashboard pages that aren't
 * built out yet, so every sidebar link resolves to something real
