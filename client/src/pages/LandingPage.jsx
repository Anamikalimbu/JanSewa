  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        {/* Desktop nav */}
        <div className="ls-nav-links" style={{ display: "flex", gap: 28, alignItems: "center" }}>
        ...
        {/* Mobile hamburger — shown only below the ls-nav-links breakpoint */}
        <button
          className="ls-nav-hamburger"
        ...
        >
          <Icon d={navOpen ? icons.twitter /* re-used as an X close icon */ : "M4 6h16M4 12h16M4 18h16"} size={22} />
        </button>
      </nav>
      ...
      {navOpen && (
        <div
          ...
          style={{
            ...
            borderBottom: "1px solid var(--border)", padding: "12px 20px 18px",
            display: "flex", flexDirection: "column", gap: 4,
          }}
        >
          {navLinks.map(({ key, label, href }) => (
            <a key={key} href={href}
              onClick={e => { e.preventDefault(); setNavOpen(false); scrollTo(href); }}
              style={{ padding: "10px 4px", fontSize: 15, fontWeight: 500, color: "var(--text-primary)", borderBottom: "1px solid var(--border)" }}
            >{label}</a>
          ))}
      ...
      <section id="home" style={{
        ...
        <div className="ls-hero-grid" style={{
      ...
      <section style={{
        ...
        <div className="ls-grid-6" style={{ display: "grid", gridTemplateColumns: "repeat(6,1fr)", gap: 12 }}>
      ...
      <main style={{ width: "100%", boxSizing: "border-box", padding: "0 32px 48px" }}>
        ...
        <div className="ls-grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 16, marginBottom: 52 }}>
        ...
        <div className="ls-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 52 }}>
          {deptKeys.map((key, i) => (
            <div key={key}
        ...
        <section id="about" style={{ paddingTop: 8 }}>
          ...
          {/* mission + values */}
          <div className="ls-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 36, marginBottom: 44, alignItems: "start" }}>
            {/* left: narrative */}
            <div style={{ textAlign: "left" }}>
            ...
            {/* right: values grid */}
            <div className="ls-grid-2-tight" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
        ...
        <section id="contact" style={{ paddingTop: 8 }}>
          ...
          <div className="ls-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 28, marginBottom: 52 }}>
            {/* contact info */}
            <div style={{ textAlign: "left" }}>
            ...
            <div style={{
              ...
              <form onSubmit={handleFormSubmit} noValidate>
                {/* name + email row */}
                <div className="ls-grid-2-tight" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                  {[
      ...
      <footer style={{
        ...
        <div style={{ display: "flex", gap: 18, flexWrap: "wrap", justifyContent: "center" }}>
          {[
            ...
            <a key={l.href} href={l.href} style={{ fontSize: 12.5, fontWeight: 600, color: "var(--text-secondary)" }}>
              {l.label}
            </a>
          ))}
        </div>
